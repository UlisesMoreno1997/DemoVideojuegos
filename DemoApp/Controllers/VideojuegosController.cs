...
namespace DemoApp.Controllers
{
    public class VideojuegosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,ImgUrl")] Videojuego videojuego)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,ImgUrl")] Videojuego videojuego)
        {
            if (ModelState.IsValid)
            {
